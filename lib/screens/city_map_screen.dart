            ...
            MutedMap(
              ...
              overlays: [
                for (final p in visible)
                  MapPin(
                    cat: p.cat,
                    position: Offset(p.xFrac * c.maxWidth, p.yFrac * c.maxHeight),
                    label: cityPins.indexOf(p) == active ? p.name : null,
                    active: cityPins.indexOf(p) == active,
                    onTap: () => setState(() => active = cityPins.indexOf(p)),
                  ),
              ],
            ),
            // Search bar
